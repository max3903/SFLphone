...
namespace sfl
{
	...
	{
		public:
			SharedMemoryException(std::string const& msg) : std::runtime_error(msg) {}
	};
	...
	class SharedMemoryPosix 
	{
		public: 
			...
			/**
			 * Shared memory destructor. It will close, unmap, and unlink the shared memory object.
			 */
			 ...
			 */
			void * getRegion() { return mappedAddr; }
