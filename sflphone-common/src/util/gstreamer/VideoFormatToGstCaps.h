...
struct VideoFormatToGstCaps: public std::unary_function<VideoFormat&, GstCaps*> {
	 ...
	 */
	static GstVideoFormat GstVideoFormatFromFourcc(guint32 fourcc) {
		switch (fourcc) {
	...
	static guint32 fourccFromGstVideoFormat(GstVideoFormat format) {
		switch (format) {
		...
		case GST_VIDEO_FORMAT_RGBx:
			return GST_MAKE_FOURCC('R', 'G', 'B', 'x');

		case GST_VIDEO_FORMAT_BGRx:
			return GST_MAKE_FOURCC('B', 'G', 'R', 'x');

		case GST_VIDEO_FORMAT_xRGB:
			return GST_MAKE_FOURCC('x', 'R', 'G', 'B');

		case GST_VIDEO_FORMAT_xBGR:
			return GST_MAKE_FOURCC('x', 'B', 'G', 'R');

		case GST_VIDEO_FORMAT_RGBA:
			return GST_MAKE_FOURCC('R', 'G', 'B', 'A');

		case GST_VIDEO_FORMAT_BGRA:
			return GST_MAKE_FOURCC('B', 'G', 'R', 'A');

		case GST_VIDEO_FORMAT_ARGB:
			return GST_MAKE_FOURCC('A', 'R', 'G', 'B');

		case GST_VIDEO_FORMAT_ABGR:
			return GST_MAKE_FOURCC('A', 'B', 'G', 'R');

		case GST_VIDEO_FORMAT_RGB:
			return GST_MAKE_FOURCC('R', 'G', 'B', ' ');

		case GST_VIDEO_FORMAT_BGR:
			return GST_MAKE_FOURCC('B', 'G', 'R', ' ');
