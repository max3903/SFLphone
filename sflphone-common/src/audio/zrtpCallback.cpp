...
zrtpCallback::zrtpCallback(SIPCall *sipcall): _sipcall(sipcall)
{
    ...
    void
zrtpCallback::secureOn(std::string cipher)
{
...
zrtpCallback::secureOff(void)
{
    ...
    void
zrtpCallback::showSAS(std::string sas, bool verified)
{
     _debug("SAS is: %s\n", sas.c_str());
...
zrtpCallback::zrtpNotSuppOther() 
{
    ...
    void
zrtpCallback::showMessage(GnuZrtpCodes::MessageSeverity sev, int32_t subCode) 
{
    string* msg;
    if (sev == Info) {
    ...
    void
zrtpCallback::zrtpNegotiationFailed(MessageSeverity severity, int subCode)
{
    string* msg;
...
map<int32, std::string*>zrtpCallback::_infoMap;
map<int32, std::string*>zrtpCallback::_warningMap;
map<int32, std::string*>zrtpCallback::_severeMap;
map<int32, std::string*>zrtpCallback::_zrtpMap;

bool zrtpCallback::_mapInitialized = false;
