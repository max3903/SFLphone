...
#ifndef __SFL_H264_GST_DECODER_SIMPLE_H__
#define __SFL_H264_GST_DECODER_SIMPLE_H__
 ...
 */
class H264GstDecoderSimple : public VideoDecoder {
public:
	/**
	 * @Override
	 */
	H264GstDecoderSimple() throw(VideoDecodingException, MissingPluginException);
	/**
	 ...
	 */
	H264GstDecoderSimple(VideoFormat& outputFormat) throw(VideoDecodingException, MissingPluginException);

	/**
	 * Delete the endpoints and stop the pipeline.
	 */
	~H264GstDecoderSimple();
...
private:
	...
	public:
		PipelineEventObserver(H264GstDecoderSimple* encoder) : parent(encoder) {}
		H264GstDecoderSimple* parent;
		/**
		 * @Override
		 */
