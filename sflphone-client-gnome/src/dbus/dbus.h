 ...
 */
gchar *
dbus_get_noise_suppress_state (void);
...
void
dbus_set_history_enabled (void);

gchar*
dbus_get_history_enabled (void);
...
gboolean
dbus_get_is_recording (const callable_obj_t *);
