...
public:
	 ...
	 * @Override
	 */
	std::string getMimeSubtype() const { return "H264"; }
	 ...
	 */
	 void setProfileLevelId(const std::string& profileLevelId) { setParameter("profile-level-id", profileLevelId); }
	 std::string getProfileLevelId() { return getParameter("profile-level-id"); }

	/**
	 *  The value of max-mbps is an integer indicating the maximum macroblock processing rate in units
     *   of macroblocks per second.
	 */
	void setMaxMbps(const std::string& maxMbps) { setParameter("max-mbps", maxMbps); }
	std::string getMaxMbps() { return getParameter("max-mbps"); }

	/**
	 * The value of max-fs is an integer indicating
     * the maximum frame size in units of macroblocks.
	 */
	void setMaxFs(const std::string& maxFs) { setParameter("max-fs", maxFs); }
	std::string getMaxFs() { return getParameter("max-fs"); }
	 ...
	 *	[1]).
	 */
	void setMaxCpb(const std::string& maxCpb) { setParameter("max-cpb", maxCpb); }
	std::string getMaxCpb() { return getParameter("max-cpb"); }

	/**
	 * The value of max-dpb is an integer indicating
     * the maximum decoded picture buffer size in units of 1024 bytes.
	 */
	void setMaxDpb(const std::string& maxDpb) { setParameter("max-dpb", maxDpb); }
	std::string getMaxDpb() { return getParameter("max-dpb"); }
	 ...
	 */
	void setMaxBr(const std::string& maxBr) { setParameter("max-br", maxBr); }
	std::string getMaxBr() { return getParameter("max-br"); }
	 ...
	 * save bandwidth.
	 */
	void setRedundantPicCap(const std::string& redundantPicCap) { setParameter("redundant-pic-cap", redundantPicCap); }
	std::string getRedundantPicCap() { return getParameter("redundant-pic-cap"); }
	 ...
	 */
	void setSpropParameterSets(const std::string& spropParameterSets) { setParameter("sprop-parameter-sets", spropParameterSets); }
	std::string getSpropParameterSets() { return getParameter("sprop-parameter-sets"); }
	 ...
	 */
	void setParameterAdd(const std::string& parameterAdd) { setParameter("parameter-add", parameterAdd); }
	std::string getParameterAdd() { return getParameter("parameter-add"); }
	 ...
	 */
	void setPacketizationMode(const std::string& packetizationMode) { setParameter("packetization-mode", packetizationMode); }
	std::string getPacketizationMode() { return getParameter("packetization-mode"); }
	 ...
	 */
	void setSpropInterleavingDepth(const std::string& spropInterleavingDepth) { setParameter("sprop-interleaving-depth", spropInterleavingDepth); }
	std::string getSpropInterleavingDepth() { return getParameter("sprop-interleaving-depth"); }
	 ...
	 *
	 */
	void setSpropDeintBufReq(const std::string& spropDeintBufReq)  { setParameter("sprop-deint-buf-req", spropDeintBufReq); }
	std::string getSpropDeintBufReq() { return getParameter("sprop-deint-buf-req"); }
	 ...
	 */
	void setDeintBufCap(const std::string& deintBufCap)  { setParameter("deint-buf-cap", deintBufCap); }
	std::string getDeintBufCap()  { return getParameter("deint-buf-cap"); }
	 ...
	 */
	void setSpropInitBufTime(const std::string& spropInitBufTime) { setParameter("sprop-init-buf-time", spropInitBufTime); }
	std::string getSpropInitBufTime() { return getParameter("sprop-init-buf-time"); }
	 ...
	 */
	void setSpropMaxDonDiff(const std::string& spropMaxDonDiff) { setParameter("sprop-max-don-diff", spropMaxDonDiff); }
	std::string getSpropMaxDonDiff() { return getParameter("sprop-max-don-diff"); }
