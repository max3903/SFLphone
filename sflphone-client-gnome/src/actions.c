  ...
  for (i = 0; i < account_list_get_size (); i++)
    {
      ...
      a->protocol_state_description = g_hash_table_lookup (details,
...
static int
_place_registered_call (callable_obj_t * c)
{
  ...
  if (g_strcasecmp (g_hash_table_lookup (current->properties, "Status"),
      "REGISTERED") == 0)
    {
