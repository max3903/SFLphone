...
void GstEncoderTheora::setChromaSubsamplingFormat(const std::string& value)
{
	_warn("max-mbps property not taken into account");
}

void GstEncoderTheora::setDeliveryMethod(const std::string& value)
{
	_warn("sampling property not taken into account");
}

void GstEncoderTheora::setConfiguration(const std::string& value)
{
	_warn("configuration property not taken into account");
}

void GstEncoderTheora::setConfigurationUri(const std::string& value)
{
	_warn("configuration-uri property not taken into account");
}

void GstEncoderTheora::setWidth(const std::string& value)
{

}
void GstEncoderTheora::setHeight(const std::string& value)
{

}

void GstEncoderTheora::setProperty(int index, const std::string& value) {
	switch (index) {
	case SAMPLING:
...
void GstEncoderTheora::init() throw (VideoDecodingException,
...
std::string GstEncoderTheora::getCodecName() {
	return "theora";
}

void GstEncoderTheora::buildEncodingFilter(Pipeline& pipeline,
		GstElement* previous) throw (VideoDecodingException,
		MissingPluginException) {

	GstElement* theoraenc = pipeline.addElement("theoraenc", previous);
...
GstEncoderTheora::GstEncoderTheora(VideoInputSource& source)
