...
#include "/home/emmanuel/sflphone/sflphone-client-kde/cmake-build/src/lib/instance_dbus_interface.h"

/**
	@author Jérémy Quentin <jeremy.quentin@savoirfairelinux.com>
*/
class LIBSFLPHONEKDE_EXPORT InstanceInterfaceSingleton
{
